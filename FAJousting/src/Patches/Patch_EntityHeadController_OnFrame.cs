...
namespace FAJousting.src.Patches
{
    ...
    public static class Patch_EntityHeadController_OnFrame
    {
        ...
        // Head clips through helmets without this patch
        static void Postfix(EntityHeadController __instance)
        {
            ...
            if (attribute == null || !attribute.GetBool("faJoustingLockHeadMovement"))
            {
                // Not wearing a jousting helmet, keep vanilla behaviour
                return;
            }
